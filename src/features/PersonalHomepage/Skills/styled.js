...
export const Section = styled.section`
    ...
    @media(max-width: ${({ theme }) => theme.breakpounts.mobileMax}px) {
        margin-top: 48px;
        padding: 16px;
    }
`;
...
export const List = styled.ul`
    ...
    @media(max-width: ${({ theme }) => theme.breakpounts.tabletHorizontalMax}px) {
       grid-template-columns: repeat(2, 1fr);
    }

    @media(max-width: ${({ theme }) => theme.breakpounts.tabletVerticalMax}px) {
      font-size: 16px;
    }
